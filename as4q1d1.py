#Q(i)(d) - logistic regression ROC final
import numpy as np
import pandas as pd
...
Xpoly = PolynomialFeatures(6).fit_transform(X1)
...
for C in C_range:
    ...
    for train, test in kf.split(Xpoly):
        ...
        #Baseline
        from sklearn.linear_model import LogisticRegression
        model = LogisticRegression(C=1).fit(X1[train], y[train])
        fpr, tpr, _ = roc_curve(y[test],model.decision_function(X1[test]))
